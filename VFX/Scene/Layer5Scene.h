...
namespace Fox {
    ...
    namespace Scene {
        ...
        class Layer5Scene : public Fox::Scene::Scene2D
        {
        public:
            Layer5Scene() = default;
            virtual ~Layer5Scene() {
            ...
            virtual void Initialize(Fox::Graphics::Managers::Vulkan::SceneId id, VkDevice device, VkPhysicalDevice physicalDevice, VkCommandPool commandPool, VkQueue queue, VkSurfaceCapabilitiesKHR capabilities) override {
                ...
                AddSprite("kettu4", root,
                    glm::vec2(capabilities.currentExtent.width * 0.35f, capabilities.currentExtent.height * 0.9f), Fox::Scene::Main2DScene::imageDimensionPercentage * 500.0f, Fox::Scene::Main2DScene::imageDimensionPercentage * 500.0f, glm::vec2(Fox::Scene::Main2DScene::imageDimensionPercentage * 0.5f * 500.0f, Fox::Scene::Main2DScene::imageDimensionPercentage * 0.5f * 500.0f), 0.0f, 1);

                AddSprite("kettu5", root,
                    glm::vec2(capabilities.currentExtent.width * 0.35f, capabilities.currentExtent.height * 0.15f), Fox::Scene::Main2DScene::imageDimensionPercentage * 500.0f, Fox::Scene::Main2DScene::imageDimensionPercentage * 500.0f, glm::vec2(Fox::Scene::Main2DScene::imageDimensionPercentage * 0.5f * 500.0f, Fox::Scene::Main2DScene::imageDimensionPercentage * 0.5f * 500.0f), 0.0f, 1);
